...
[English](../en/10-release-notes.md) | 中文

**文档版本**：V1.2　**日期**：2026-08-24
...
| `09-downloads`（中英文） | V1.1 | 2026-08-19 | 页眉与仓库目录结构与 V1.1 对齐 |
| 07 第三方 MQTT 协议（中英文） | V1.0 | 2026-08-24 | 协议 Word、`IEPro-deploy.zip`（agent、Web 界面、Boa）与部署步骤 |
| 文档套件（中英文） | V1.2 | 2026-08-24 | 新增 07 第三方协议；FAQ / 资料下载 / 版本说明改编号为 08 / 09 / 10 |
